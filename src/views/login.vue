  ...
  <section class="login-block">
    <div class="container">
      <div class="row" style="">
        ...
        >
          <img
            src="/src/assets/images/clientlogo_astahealthcare.com_f1800.png"
            width="200"
          />
        </div>
        <div class="col-md-12">
          <div class="box_login">
            <div class="row">
              <div class="col-md-4 login-sec">
                ...
                <InlineMessage severity="error" v-if="error"
                  >{{ error }}
                </InlineMessage>
                ...
                <form id="account" method="post" class="mt-2">
                  ...
                  <div class="form-check">
                    ...
                    <button
                      id="login-submit"
                      type="submit"
                      class="btn btn-sm btn-login float-right"
        ...
        <div class="col-md-12 mt-5">
          <p style="text-align: center">
            Copyright ©2023 <b style="color: #2fa95e">ASTA</b>. All Rights
            Reserved.
          </p>
        </div>
      </div>
  ...
  authApi
    ...
    .then((res) => {
      ...
      if (res.authed) {
        ...
        var groups = ["Administrator", "Manager Trend"];
        let re = false;
        let user_roles = res.user.roles;
        if (user_roles) {
