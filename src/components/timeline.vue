        ...
        <div class="col-md-8 control-section">
            <div class="content-wrapper">
                <ejs-gantt ref='gantt' id="GanttContainer" :dataSource="data" :taskFields="taskFields" :height="height"
                    :highlightWeekends='true' :projectStartDate="projectStartDate" :projectEndDate="projectEndDate"
        ...
        <div class="col-md-4 property-section">
            <table id="property" title="Properties" style="width: 100%">
                <tr>
                    ...
                    <td style="width: 70%;">
                        <div>
                            <ejs-numerictextbox ref='unitWidth' id="unitWidth" :min='10' format='##' :value='33'
                                :change='unitWidthChange'></ejs-numerictextbox>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 70%">
                        <div>
                            <ejs-checkbox ref='topTierCheckbox' class='checkbox' id='topTierCheck' :checked="true"
                                :change="topTierCick"></ejs-checkbox>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 70%;">
                        <div id='numericbox'>
                            <ejs-numerictextbox ref='topTierCount' id="count" :min='1' :max='50' format='##' :value='1'
                                :change='topTierCountchange'></ejs-numerictextbox>
                        </div>
                    </td>
                </tr>
                    ...
                    <td style="width: 70%">
                        <div>
                            <ejs-dropdownlist ref='topTierFormat' id="format" index="1" value="MMM dd, yyyy"
                                :dataSource="weekformat" :fields="formatFields" :change="topFormatChange">
                            </ejs-dropdownlist>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="width: 70%">
                        <div>
                            <ejs-checkbox ref='bottomTierCheckbox' id="bottomTierCheck" :checked="check"
                                :change="bottomTierCick">
                            </ejs-checkbox>
                        </div>
                    </td>
                </tr>
                    ...
                    <td style="width: 70%;">
                        <div id='numericbox'>
                            <ejs-numerictextbox ref='bottomTierCount' id="btcount" :min='1' :max='50' format='##' :value='1'
                                :change='bottomTierCountchange'></ejs-numerictextbox>
                        </div>
                    </td>
                </tr>
                <tr>
